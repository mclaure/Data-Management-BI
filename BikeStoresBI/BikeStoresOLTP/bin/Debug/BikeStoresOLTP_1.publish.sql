/*
Deployment script for BikeStoresOLTP
...
GO
:setvar DatabaseName "BikeStoresOLTP"
:setvar DefaultFilePrefix "BikeStoresOLTP"
...
GO
PRINT N'Creating Foreign Key [production].[FK_stocks_products]...';
...
GO
PRINT N'Creating Foreign Key [production].[FK_stocks_stores]...';
...
GO
PRINT N'Creating Foreign Key [sales].[FK_order_items_orders]...';
...
GO
PRINT N'Creating Foreign Key [sales].[FK_order_items_products]...';
...
GO
PRINT N'Creating Foreign Key [sales].[FK_orders_staffs]...';
...
GO
PRINT N'Creating Foreign Key [sales].[FK_staffs_staffs]...';
...
GO
PRINT N'Creating Foreign Key [sales].[FK_staffs_stores]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[GetOrdersChangesByRowVersion]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[GetProductChangesByRowVersion]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[GetStaffChangesByRowVersion]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[GetStoreChangesByRowVersion]...';
...
ALTER TABLE [production].[stocks] WITH CHECK CHECK CONSTRAINT [FK_stocks_products];

ALTER TABLE [production].[stocks] WITH CHECK CHECK CONSTRAINT [FK_stocks_stores];

ALTER TABLE [sales].[order_items] WITH CHECK CHECK CONSTRAINT [FK_order_items_orders];

ALTER TABLE [sales].[order_items] WITH CHECK CHECK CONSTRAINT [FK_order_items_products];

ALTER TABLE [sales].[orders] WITH CHECK CHECK CONSTRAINT [FK_orders_customers];

ALTER TABLE [sales].[orders] WITH CHECK CHECK CONSTRAINT [FK_orders_staffs];

ALTER TABLE [sales].[orders] WITH CHECK CHECK CONSTRAINT [FK_orders_stores];

ALTER TABLE [sales].[staffs] WITH CHECK CHECK CONSTRAINT [FK_staffs_staffs];

ALTER TABLE [sales].[staffs] WITH CHECK CHECK CONSTRAINT [FK_staffs_stores];
